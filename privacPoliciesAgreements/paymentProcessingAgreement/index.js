...
export async function paymentProcessingAgreementLoader(){
    return {
...
const PaymentProcessingAgreement = () => {

  return (
    <>
      <div className="w-full p-10">
        <h1 className="text-2xl font-bold text-gray-800">Payment Processing Agreement</h1>
...
export default PaymentProcessingAgreement;
