...
export async function venueProviderAgreementLoader(){
    return {
...
const VenueProviderAgreement = () => {

  return (
    <>
      <div className="w-full p-10">
        <h1 className="text-2xl font-bold text-gray-800">Venue Provider Agreement</h1>
...
export default VenueProviderAgreement;
