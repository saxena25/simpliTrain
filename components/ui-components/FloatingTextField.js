  ...
  return (
    <div className="relative w-full mb-3">
        <div className={`flex bg-input-background rounded-lg overflow-hidden ${className}`}>
          ...
          {
            multiline?
            <textarea {...props} type={type} id={id} name={name} className="block h-full min-h-16 px-4 pb-2.5 pt-7 w-full text-base text-input-text placeholder-transparent bg-input-background border-0 appearance-none  focus:outline-none focus:ring-0 focus:border-0 peer" placeholder={placeholder}>{props?.value}</textarea>
